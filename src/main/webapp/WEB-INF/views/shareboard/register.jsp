...
<body>
  <h6><a href="list" style="color: black; 
	          text-decoration: none;"><strong>공유게시판</strong></a> > 글 작성</h6>
  <hr>
  <form action="register" id="form" method="POST">
    ...
    <input type="hidden" name="userid" value="${loginId }">
      <p>작성자 : ${loginId }</p>
      <p>제목 : 
      	<input style="width:70%;" type="text" id="title" name="shareboard_title" placeholder="제목 입력" required="required">
      	<!-- 공지글 설정 (관리자 전용) -->
      	<c:if test="${part eq 'manager' }"> | 
       	  <select name="shareboard_notice">
	...
	<!-- TinyMCE -->
    <div>
		<textarea id="editor" name="shareboard_content" required></textarea>
    </div>
    <!-- 하단버튼 -->
    <div>
